...
IKB is the artifact being launched as a public RAG+MCP demo for consulting inbound. The launch plan (channel decisions, success criteria, hurdle ladder, measurement infra) lives in `~/consulting-research/docs/rag-demo/` — `README.md`, `tracking.md`, `hurdle-playbook.md`. Don't reconstruct launch decisions from IKB context; read those docs.
